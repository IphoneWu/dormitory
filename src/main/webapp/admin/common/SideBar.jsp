    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src=" ${sessionScope.dormAdmin.dormadminImage}" class="img-circle" alt="User Image">
            </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview" id="m1" style="display: none;">
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="/admin/NoRepair.jsp">未审核的申请</a></li>
                    <li><a href="/admin/IsRepair.jsp">已审核的申请</a></li>
                </ul>
            </li>

            <li class="treeview">
                <a href=""><i class="fa fa-link"></i> <span>请假信息管理</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="/admin/NoSituation.jsp">未审核的申请</a></li>
                    <li><a href="/admin/isSituation.jsp">已审核的申请</a></li>
                </ul>
            </li>
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li id="m2" style="display: none;"><a href="/admin/Link.jsp">友情链接管理</a></li>
                    <li id="m3" style="display: none;"><a href="/admin/RegisterCode.jsp">注册邀请码</a></li>
