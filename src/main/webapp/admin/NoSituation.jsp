...
<script>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            type:'post',
            url:'/admin/situation/getSitList.do?page=1&eventStatus=0',
            async: false,
            success:function (data) {
                ...
                $.each(data.data, function(i,item){
                    $("#mainTable").append('<tr role="row" class="odd">' +
                            ...
                            '<td class="sorting_1"><a href="/admin/situation/getSit.do?situationId='+item.situationId+'">修改</a></td></tr>')
                });
    ...
    function getTable(now) {
        ...
        $.ajax({
            type: 'post',
            url: '/admin/situation/getSitList.do?eventStatus=0&page=' + now,
            async: false,
            success: function (data) {
                totalNum = data.totalNum;
                currentPage = data.pageNum;
    ...
    function searchSit(page) {
        ...
        $.ajax({
            type: 'post',
            url: '/admin/situation/sitSearch.do?eventStatus=0&page='+page+'&sitSearch='+sitSearch,
            async: false,
            success: function (data) {
                totalNum = data.totalNum;
                currentPage = data.pageNum;
