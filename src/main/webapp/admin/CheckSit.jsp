        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-footer text-center">
                    <button class="btn btn-success" style="padding: 10px 20px;" onclick="checkSit(1)">通过</button>
                    <button class="btn btn-danger" style="padding: 10px 20px;" onclick="checkSit(-1)">不通过</button>
...
<script>
    ...
    function checkSit(action) {

        var txt = "确定审批吗？";
        var option = {
            onOk: function () {
                var situationId = ${situation.situationId};
                $.ajax({
                    method: 'post',
                    url: '/admin/situation/updateSit.do?eventStatus='+action+'&situationId='+situationId,
                    async: false,
