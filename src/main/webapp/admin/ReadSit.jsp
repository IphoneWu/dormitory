        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border text-center">
                    <h1 class="box-title">请假单号:${repair.repairNum}</h1>
                ...
                <div class="box-body">
                    <div class="col-xs-12 table-responsive text-center" style="padding: 30px 0;">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td width="50%" class="text-right"><label>返校时间:</label></td>
                                <td id="formatReturnTime" width="50%" class="text-left">
                            ...
                            <tr>
                                <td width="50%" class="text-right"><label>审批结果:</label></td>
...
<script>
    $(document).ready(function() {
        ...
        var leaveTime = new Date(("${situation.leaveTime}")).Format("yyyy-MM-dd hh:mm:ss");
        var returnTime = new Date(("${situation.returnTime}")).Format("yyyy-MM-dd hh:mm:ss");
        var eventStatus = "${situation.eventStatus}";
        $("#formatLeaveTime").html(leaveTime);
        if(eventStatus==1){
            $("#Status").html('已通过');
        }else {
            $("#Status").html('不通过');
        ...
        if(returnTime==null){
            $("#formatReturnTime").html('尚未回校');
        }else {
            $("#formatReturnTime").html(returnTime);
        }
    ...
    function goback() {
        window.location.href = "/admin/NoSituation.jsp";
    }
</script>
