...
<script>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            type:'post',
            url:'/admin/repair/getRepairList.do?page=1&repairStatus=0',
            async: false,
    ...
    function getTable(now) {
        ...
        $.ajax({
            type: 'post',
            url: '/admin/repair/getRepairList.do?repairStatus=0&page=' + now,
            async: false,
            success: function (data) {
                totalNum = data.totalNum;
                currentPage = data.pageNum;
    ...
    function searchRepair(page) {
        ...
        $.ajax({
            type: 'post',
            url: '/admin/repair/repairSearch.do?repairStatus=0&page='+page+'&repairSearch='+repairSearch,
            async: false,
            success: function (data) {
                totalNum = data.totalNum;
                currentPage = data.pageNum;
