...
<div class="container" style="margin-top: 10px;">
    <div class="row">
        <div id="mainContent" class="col-md-8 table-responsive">
            <!-- Default box -->
            <div class="box" style="margin-top: 73px;">
                <div class="box-header with-border text-center">
                    <h1 class="box-title">编写报修申请</h1>
                    ...
                    <div class="col-md-12  text-center" style="padding: 30px 0;">
                        <form id="addRepairForm">
                            <table class="table table-bordered table-hover">
                                <tr>
                                    <td width="50%" class="text-right"><label for="porpertyName">报修物品:</label></td>
                                    <td width="60%" class="text-left">
                                        <input id="porpertyName" name="porpertyName" type="text">
                                    </td>
                                </tr>
                                <tr>
                                    <td  class="text-right"><label for="repairReason">报修原因:</label></td>
                                    <td class="text-left">
                                        <textarea id="repairReason" name="repairReason" style="width: 300px;height: 100px;"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="50%" class="text-right"><label for="addrezz">维修地点:</label></td>
                                    <td width="60%" class="text-left">
                                        <input id="addrezz" name="addrezz" type="text">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="50%" class="text-right"><label for="studentNum">报修人学号:</label></td>
                                    <td width="60%" class="text-left">
                ...
                <div class="box-footer text-center">
                    <button class="btn btn-success" style="padding: 10px 20px;" onclick="sumitRepair()">提交</button>
...
<script>
    ...
    function sumitRepair() {
        var txt = "确定提交吗？";
        var option = {
            onOk: function () {
                var params = $("#addRepairForm").serializeArray();
                $.ajax({
                    method: 'post',
                    url: '/user/addRepair.do',
                    data:params,
                    async: false,
                    success: function (data) {
                        if (data.code == 1) {
