        ...
        <div id="mainContent" class="col-md-8">
            ...
            <div class="box" style="margin-top: 73px;">
                    ...
                    <div class="col-md-12 table-responsive text-center" style="padding: 30px 0;">
                        <form id="addSitForm">
                            <table class="table table-bordered table-hover">
                                <tr>
                                    <td  class="text-right"><label for="event">请假原因:</label></td>
                                    <td class="text-left">
                                        <textarea id="event" name="event" style="width: 500px;height: 100px;"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="50%" class="text-right"><label for="studentNum">请假人学号:</label></td>
                ...
                <div class="box-footer text-center">
                    <button class="btn btn-success" style="padding: 10px 20px;" onclick="sumitSituation()">提交</button>
...
<script>
    ...
    function sumitSituation() {
        ...
        var option = {
            onOk: function () {
                var params = $("#addSitForm").serializeArray();
                $.ajax({
                    method: 'post',
                    url: '/user/addSit.do',
                    data:params,
