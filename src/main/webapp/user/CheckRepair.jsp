        ...
        <div id="mainContent" class="col-md-8">
            ...
            <div class="box" style="margin-top: 73px;">
                <div class="box-header with-border text-center">
                    <h1 class="box-title">保修单号:${repair.repairNum}</h1>
                        ...
                        <form id="changeSitForm">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td id="formatsubTime" width="50%" class="text-left">

                                    </td>
                                </tr>
                                <tr>
                                    <td width="50%" class="text-right"><label>审批时间:</label></td>
                                    <td id="formatresTime" width="50%" class="text-left">
...
<script>
    $(document).ready(function() {
        var submitTime = new Date(("${repair.submitTime}")).Format("yyyy-MM-dd hh:mm:ss");
        var resolveTime = new Date(("${repair.resolveTime}")).Format("yyyy-MM-dd hh:mm:ss");
        var repairStatus = "${repair.repairStatus}";
        $("#formatsubTime").html(submitTime);
        $("#formatresTime").html(resolveTime);
        if(repairStatus==1){
            $("#Status").html('已通过');
        }else {
            $("#Status").html('不通过');
